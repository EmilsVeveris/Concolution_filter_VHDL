...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios2_system_v0.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios2_system_v0
SOPC_NAME := nios2_system_v0
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100111a0
SOPC_SYSID_FLAG += --sidp=0x100111a0
ELF_PATCH_FLAG  += --sidp 0x100111a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1610385226
SOPC_SYSID_FLAG += --timestamp=1610385226
ELF_PATCH_FLAG  += --timestamp 1610385226
